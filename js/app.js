...
const DOCS_PATH = 'assets/Doku.md';
...
function bindUI() {
  ...
  dom.lessDetailBtn.addEventListener('click', () => adjustTerrainDetail(-1));
  dom.moreDetailBtn.addEventListener('click', () => adjustTerrainDetail(1));
